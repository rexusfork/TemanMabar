...
public class AdapterTemanMabar extends RecyclerView.Adapter<AdapterTemanMabar.ViewHolder> {
    private Context context;
    private ArrayList<Tebargame> list;

    public AdapterTemanMabar(Context context, ArrayList<Tebargame> list) {
